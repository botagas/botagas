...
- 🛠️ I’m all about **self-hosting**, automation, and experimenting with tools like **Proxmox, WireGuard, Yunohost, Docker** and more.
- 💻 I don't consider myself a developer—but with tools like **VS Code** and **GitHub Copilot**, I’ve been contributing much more actively.
- 🌐 Passionate about open source and contributing where I can.
...
- 🛠️ **Media Statistics and Cleanup**: Contributing to enhancing media playback analytics and exploring media cleanup options for self-hosted media servers.
